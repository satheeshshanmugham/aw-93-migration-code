...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template match="/">
            ...
            <topic>             
                ...
                <title><xsl:value-of select="normalize-space(html/head/meta[@name='title']/@content)"/></title>
                <abstract><xsl:value-of select="html/head/meta[@name='abstract']/@content"/></abstract>
                <description><xsl:value-of select="normalize-space(html/head/meta[@name='description']/@content)"/></description>                
                <keywords><xsl:value-of select="html/head/meta[@name='keywords']/@content"/></keywords>
                <guid><xsl:value-of select="html/head/meta[@name='guid']/@content"/></guid>                
                <format>HTML5</format>
                <language>en</language>
                <last-modified><xsl:value-of select="html/head/meta[@name='last modified']/@content"/></last-modified>
                <author>cdebeer</author>
